        ...
        <div>
            ...
            <div className='container mt-3 p-5' style={{ textAlign: "center", backgroundColor: "beige" }}>
                <div style={{ width: "100%", display: "inline-block" }}><span style={{ fontSize: "30px" }}>Our Exclusives</span><br></br>
                    SRIRAM celebrates every occasion of life through its mindfully designed adornments that reflect tradition, culture and intricacy of craftsmanship embodied in exclusive ranges of quality jewellery.
                </div>
            </div>
